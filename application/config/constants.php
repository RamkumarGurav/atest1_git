...
////project details
define('_project_name_', "A TEST 1");//this is used in 
define('_project_name_for_web_title_', "A TEST 1"); # to display
define('_project_complete_name_', "A TEST 1"); # to display
define('_brand_name_', "AT1");//need in left_nav
...
// define('_project_contact_whatsapp_message_', "Welcome to A TEST 1");
// define('_project_email_', "info@atest1.in");

// define('__adminemail__', "info@atest1.in");
// define('__adminsms__', "919392199595");  // for Register

// define('_project_web_', "www.atest1.in");
// define('_mainsite_hostname_', "atest1.in");

// define('_SMS_BRAND_', "atest1.in");
...
// define('_INSTAGRAM_', "https://instagram.com/atest1.rythusevakendram?utm_source=qr");
// define('_TWITTER_', "");
// define('_YOUTUBE_', "https://youtube.com/@atest1_farmer?si=G2mHlloY4qTbuUsd");
// define('_PINTEREST_', "");
// define('_LINKEDIN_', "");
