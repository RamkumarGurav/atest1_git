...
class Company_profile_module extends Main
{
	...
	function index()
	{
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/company_profile/Company_profile_module/list', $this->data);
		parent::get_footer();
	}
	...
	function list()
	{
		...
		$this->data['country_data'] = $this->Common_model->getData(array('select' => '*', 'from' => 'country', 'where' => "country_id > 0", "order_by" => "name ASC"));
		$this->data['users_role_data'] = $this->Common_model->getData(array('select' => '*', 'from' => 'admin_user_role', 'where' => "admin_user_role_id > 0", "order_by" => "name ASC"));
		$this->data['designation_data'] = $this->Common_model->getData(array('select' => '*', 'from' => 'designation', 'where' => "designation_id > 0", "order_by" => "name ASC"));
	...
	function list_export()
	{
		...
		$this->load->view('admin/company_profile/Company_profile_module/list_export', $this->data);
	}

	function view($company_profile_id = "")
	{
		$this->data['page_type'] = "list";
		$user_access = $this->data['user_access'] = $this->data['User_auth_obj']->check_user_access(array("module_id" => $this->data['page_module_id']));
		...
		$this->data['company_profile_data'] = $this->Company_profile_model->get_company_profile_data(array("company_profile_id" => $company_profile_id));
		...
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/company_profile/Company_profile_module/view', $this->data);
		parent::get_footer();
	}

	function edit($company_profile_id = "")
	{
		$this->data['page_type'] = "list";
		$user_access = $this->data['user_access'] = $this->data['User_auth_obj']->check_user_access(array("module_id" => $this->data['page_module_id']));
		...
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/company_profile/Company_profile_module/edit', $this->data);
		parent::get_footer();
	}
	...
	function do_edit()
	{
		...
		if (!empty($company_profile_id)) {
			...
			if (!empty($insertStatus)) {
				...
				$this->upload_any_image("company_profile", "company_profile_id", $company_profile_id, "letterhead_header_image", "letterhead_header_image", "letterhead_header_image_", "company_profile/letterhead_header_image");
				$this->upload_any_image("company_profile", "company_profile_id", $company_profile_id, "logo", "logo", "logo_", "company_profile/logo");
