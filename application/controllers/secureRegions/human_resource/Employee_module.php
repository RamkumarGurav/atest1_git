...
class Employee_module extends Main
{
	...
	function list()
	{
		...
		//getting count
		$data_count = $this->Employee_model->get_employee_data($search);
		...
		$this->data['employee_data'] = $this->Employee_model->get_employee_data($search);
	...
	function list_export()
	{
		...
		$this->load->view('admin/human_resource/Employee_module/list_export', $this->data);
	}
	...
	function view($admin_user_id = "")
	{
		...
		$this->data['employee_data'] = $this->Employee_model->get_employee_data(array("admin_user_id" => $admin_user_id, "details" => 1));
	...
	function edit($admin_user_id = "")
	{
		...
		parent::get_header();
		parent::get_left_nav();
		$this->load->view('admin/human_resource/Employee_module/edit', $this->data);
		parent::get_footer();
	}
	...
	public function addNewLine_auf()
	{
		...
		$template = $this->load->view('admin/human_resource/Employee_module/template/file_line_add_more_auf', $this->data, true);
		echo json_encode(array("template" => $template));
	}
