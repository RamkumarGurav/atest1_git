										...
										<tbody>
											...
											foreach ($employee_data as $urm) {
												...
												<tr>
													...
													<?php } ?>
													<td><a
															href="<?php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->admin_user_id ?>"><?php echo $urm->name ?></a>
													</td>
													<td>
														<?php
														if (!empty($urm->roles)) {
															if (count($urm->roles) > 1) {
																...
																echo $urm->roles[0]->admin_user_role_name;
															}
														}
														?>
														<?php  //=$urm->admin_user_role_name ?>
