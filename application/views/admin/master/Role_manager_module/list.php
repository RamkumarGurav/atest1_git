                                    ...
                                    <table id="example1" class="table table-bordered table-hover table-striped">
                                        ...
                                        <?php if (!empty($admin_user_role_data)) { ?>
                                                    <tbody>
                                                        ...
                                                        foreach ($admin_user_role_data as $urm) {
                                                            $count++;
                                                            ?>
                                                                    <tr>
                                                                        ...
                                                                        <?php if ($user_access->update_module == 1) { ?>
                                                                                    <td><input type="checkbox" name="sel_recds[]" id="sel_recds<?php echo $count; ?>"
                                                                                            value="<?php echo $urm->admin_user_role_id; ?>" /></td>
                                                                        <?php } ?>
                                                                        <td><a
                                                                                href="<?php echo MAINSITE_Admin . $user_access->class_name . "/view/" . $urm->admin_user_role_id ?>"><?php echo $urm->name ?></a>
                                                                        </td>
