...
class User_auth
{
	...
	function __construct()
	{
		...
		$this->session_uid = $this->CI->session->userdata('sess_current_uid');
		$this->session_name = $this->CI->session->userdata('sess_current_name');
		$this->session_email = $this->CI->session->userdata('sess_current_email');
		$this->session_aurid = $this->CI->session->userdata('sess_current_aurid');
		...
		if ($this->session_uid > 0 && !empty($this->session_name)) {
			...
			if (!empty($this->data['user_data'])) {
				...
				if ($this->data['user_data']->status != 1) {
					...
					$this->CI->session->unset_userdata('sess_current_uid');
